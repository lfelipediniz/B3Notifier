...
### Tip
The deployment was carried out using cloud platforms. Feel free to test it beyond localhost: [B3 Notifier](http://b3notifier.me) (Since it is in the cloud, resources may be more limited).
## Table of Contents
